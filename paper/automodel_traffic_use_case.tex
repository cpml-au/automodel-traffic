...
by 23.17\%, and also reduced $E_{\mathrm{TTS}}$ from 0.152 to 0.121. Automodel
improved held-out $E_{\mathrm{data}}$ for four of the five baseline families;
the exception was IDM, for which the score increased by 2.30\%. The uncorrected
Weidmann model attained the lowest TTS error. The TTS diagnostic was not part
of model selection and did not improve consistently across the selected
corrections. Figure~\ref{fig:traffic-fields} shows the measured spatio-temporal
...
\begin{table}[t]
    ...
    \begin{tabular}{@{}lrrrrr@{}}
        ...
        AM--Greenshields   & 0.255 & 0.277 & 7.092 (3)  & $+23.17\%$ & 0.121 \\
        IDM                & 0.258 & 0.270 & 6.957 (2)  & --        & 0.116 \\
        AM--IDM            & 0.256 & 0.277 & 7.117 (4)  & $-2.30\%$  & 0.125 \\
        Weidmann           & 0.265 & 0.288 & 7.651 (8)  & --        & \textbf{0.115} \\
        AM--Weidmann       & 0.265 & 0.281 & 7.459 (7)  & $+2.51\%$  & 0.117 \\
        Triangular         & 0.269 & 0.294 & 7.919 (9)  & --        & 0.129 \\
        AM--Triangular     & 0.256 & 0.277 & 7.118 (5)  & $+10.11\%$ & 0.127 \\
        Del Castillo       & 0.257 & 0.279 & 7.197 (6)  & --        & 0.119 \\
        AM--Del Castillo   & \textbf{0.253} & \textbf{0.267}
                           & \textbf{6.780 (1)} & $+5.80\%$ & 0.123 \\
        \bottomrule
    \end{tabular}
\end{table}
...
Automodel uniformly improves every classical diagram or aggregate metric.
